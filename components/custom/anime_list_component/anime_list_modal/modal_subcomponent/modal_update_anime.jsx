...
export function ModalUpdateAnime({ isOpen, onClose, seriesId, handleUpdateAnime }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-xl lg:max-w-2xl ">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold">Change Anime Series Name</DialogTitle>
        </DialogHeader>     
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <Field>
            <Input {...register("name")} placeholder="Enter a new anime series name" required />
          </Field>
